---
title: Danish pay concepts
slug: danish-pay-terms
summary: Tax card, AM-bidrag, feriepenge, fritvalgskonto, ATP — the Danish terms BitGigs uses, briefly explained.
parent:
audience: everyone
order: 65
published: true
...
[skat.dk](https://skat.dk) (tax), [borger.dk](https://www.borger.dk)
(vacation and public benefits) and [atp.dk](https://www.atp.dk) (ATP) — in
English, [lifeindenmark.borger.dk](https://lifeindenmark.borger.dk) covers
most of this.
...
Danish law gives 25 vacation days a year, funded in one of two ways:

- **Feriepenge via FerieKonto** — typical for **hourly** jobs: the employer
  pays **12,5%** of your earnings into FerieKonto, and you claim it out when
  you take vacation (see borger.dk).
- **Accrued paid vacation** — typical for **salaried** jobs: you earn
  **2,08 days per month** and keep your salary while on holiday. On top comes
  **ferietillæg**, a supplement of (at least) **1%** of your yearly pay,
...
| Term | Meaning |
|---|---|
| **Overenskomst** | A collective agreement between unions and employers; the source of most of the extras below. |
| **Fritvalgskonto** | A "free-choice" account: a percentage of your pay (rising over the years in most agreements) that you can have paid out or saved — some jobs pay it monthly, some accrue it. |
| **Arbejdsmarkedspension** | Workplace pension: your own contribution (deducted before tax) plus your employer's (paid on top of your salary). |

> When in doubt, your payslip and your overenskomst are the ground truth —
> BitGigs estimates, it doesn't replace them.
